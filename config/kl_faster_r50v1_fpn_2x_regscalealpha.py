...
from models.kl_loss.builder import KLFPNBbox2fcHead as BboxHead
...
def get_config(is_train):
    ...
    class OptimizeParam:
        ...
        class schedule:
            begin_epoch = 0
            end_epoch = 12
            lr_iter = [60000 * 16 * 2 // (len(KvstoreParam.gpus) * KvstoreParam.batch_image),
                       80000 * 16 * 2 // (len(KvstoreParam.gpus) * KvstoreParam.batch_image)]
